...
- `pyproject.toml` has been updated and modified, dependencies are updated.
- The optional dependence of `pip install hdrezka[socks]` for socks-proxy has been added.

  Previously, for this, it was necessary to `pip install httpx[socks]` directly.
